            ...
            <body>
                <div className="hero_area">
                    ...
                    <div className="container-fluid">
                        ...
                        <a className="navbar-brand disabled" href="javascript:void(0)">
                            <img src={logo} alt="" />
                            <span>
                            {app}
                            </span>
                        ...
                        <div className="navbar-collapse" id="">
                            ...
                            <div className=" mr-auto flex-column flex-lg-row align-items-center">
                                ...
                                <div className="User_option">
                                    ...
                                    <li className="">
                                    <select name="lang" id="lang" style={{backgroundColor:"transparent",borderColor:"transparent",color:"white",textDecoration:"none"}} onChange={()=>handleClick('en')} defaultValue="en">
                ...
                <section className="service_section layout_padding-bottom" id="service">
                    <div className="container">
                    ...
                    <div className="service_container">
                        <div className="box">
                        <div className="img-box">
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 60 60" className="icon_style1" xmlSpace="preserve">
                            <g>
                        ...
                        <div className="box">
                        <div className="img-box">
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" className="icon_style2" xmlSpace="preserve">
                            <g>
                                <g>
                        ...
                        <div className="box">
                        <div className="img-box">
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" className="icon_style2" xmlSpace="preserve">
                            <g>
                                <g>
                ...
                <section className="feature_section layout_padding-bottom">
                    <div className="container">
                    <div className="row">
                        <div className="col-md-6">
                        <div className="img-box">
